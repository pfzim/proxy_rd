...
function create_header($method, $host, $uri, $protocol, $aut, $useaut)
{
	...
	if($test === "me")
	{
		...
		echo '<html><body><form action="'.$_SERVER["PHP_SELF"].'?test=do" method="post" enctype="multipart/form-data">';
		...
		echo '<input type="submit" value="Test!"></form></body></html>';
		exit;
	}
	...
	if($test === "do")
	{
		...
		echo create_header("POST", "TEST", "TEST", "HTTP/9.9", 0, 0);
		exit;
	}
